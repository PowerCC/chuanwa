...
{
    self = [self initWithFrame:frame horizontalPadding:8 verticalPadding:7.5 inputViewMinHeight:38 inputViewMaxHeight:150 type:EMChatToolbarTypeGroup];
    if (self) {
...
{
    self = [self initWithFrame:frame horizontalPadding:8 verticalPadding:7.5 inputViewMinHeight:38 inputViewMaxHeight:150 type:type];
    if (self) {
...
//    [self addSubview:_backgroundImageView];
    ...
    //input textview
    _inputTextView = [[EaseTextView alloc] initWithFrame:CGRectMake(self.horizontalPadding, self.verticalPadding, self.frame.size.width - self.verticalPadding * 2, 36)];
...
//    _inputTextView.placeHolder = NSEaseLocalizedString(@"message.toolBar.inputPlaceHolder", @"input a new message");
    ...
    _inputTextView.layer.borderColor = kCOLOR(224, 226, 234, 1).CGColor;
...
//    [styleChangeButton setImage:[UIImage imageNamed:@"EaseUIResource.bundle/chatBar_keyboard"] forState:UIControlStateSelected];
    [styleChangeButton setImage:[UIImage imageNamed:@"im-voice"] forState:UIControlStateNormal];
    [styleChangeButton setImage:[UIImage imageNamed:@"im-keyboard"] forState:UIControlStateSelected];
    ...
    [self.recordButton setTitleColor:kCOLOR(102, 102, 102, 1) forState:UIControlStateNormal];
    [self.recordButton setBackgroundImage:[[UIImage imageWithColor:[UIColor whiteColor] size:self.recordButton.bounds.size] stretchableImageWithLeftCapWidth:10 topCapHeight:10] forState:UIControlStateNormal];
    [self.recordButton setBackgroundImage:[[UIImage imageWithColor:kCOLOR(224, 226, 234, 1) size:self.recordButton.bounds.size]stretchableImageWithLeftCapWidth:10 topCapHeight:10] forState:UIControlStateHighlighted];
    self.recordButton.layer.borderColor = kCOLOR(224, 226, 234, 1).CGColor;
...
//    [self.faceButton setImage:[UIImage imageNamed:@"EaseUIResource.bundle/chatBar_keyboard"] forState:UIControlStateSelected];
    [self.faceButton setImage:[UIImage imageNamed:@"im-emoji"] forState:UIControlStateNormal];
    [self.faceButton setImage:[UIImage imageNamed:@"im-keyboard"] forState:UIControlStateSelected];
...
//    [self.moreButton setImage:[UIImage imageNamed:@"EaseUIResource.bundle/chatBar_keyboard"] forState:UIControlStateSelected];
    [self.moreButton setImage:[UIImage imageNamed:@"im-plus"] forState:UIControlStateNormal];
    [self.moreButton setImage:[UIImage imageNamed:@"im-keyboard"] forState:UIControlStateSelected];
...
{
    if (_recordView == nil) {
        _recordView = [[EaseRecordView alloc] initWithFrame:CGRectMake(0, 0, 154, 154)];
    }
...
{
    if (_moreView == nil) {
        _moreView = [[EaseChatBarMoreView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_toolbarView.frame), self.frame.size.width, 120) type:self.chatBarType];
