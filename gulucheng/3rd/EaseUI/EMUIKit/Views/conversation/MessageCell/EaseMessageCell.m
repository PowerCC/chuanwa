...
@property (strong, nonatomic) UIImage *sendBackgroundImage;
@property (strong, nonatomic) UIImage *recvBackgroundImage;
...
+ (void)initialize
{
    ...
    cell.bubbleMaxWidth = 301;
    cell.leftBubbleMargin = UIEdgeInsetsMake(7, 16, 7, 16);
    cell.rightBubbleMargin = UIEdgeInsetsMake(7, 16, 7, 16);
    cell.bubbleMargin = UIEdgeInsetsMake(7, 0, 7, 0);
    
    cell.messageTextFont = [UIFont systemFontOfSize:16];
    cell.sendMessageTextColor = [UIColor whiteColor];
    cell.recvMessageTextColor = kCOLOR(34, 34, 34, 1);
    ...
    cell.sendBackgroundImage = [UIImage imageWithColor:kCOLOR(255, 138, 117, 1)];
    cell.recvBackgroundImage = [UIImage imageWithColor:[UIColor whiteColor]];
}
                        ...
                        model:(id<IMessageModel>)model
{
    ...
    if (self) {
        ...
        self.sendMessageTextColor = [UIColor whiteColor];
        self.recvMessageTextColor = kCOLOR(34, 34, 34, 1);
        self.sendBackgroundImage = [UIImage imageWithColor:kCOLOR(255, 138, 117, 1)];
        self.recvBackgroundImage = [UIImage imageWithColor:[UIColor whiteColor]];
        
        [self setSendMessageVoiceAnimationImages:[NSArray arrayWithObjects:[UIImage imageNamed:@"im-send-audio-1"],
                                                  [UIImage imageNamed:@"im-send-audio-2"],
                                                  [UIImage imageNamed:@"im-send-audio-3"], nil]];
        [self setRecvMessageVoiceAnimationImages:[NSArray arrayWithObjects:[UIImage imageNamed:@"im-recv-audio-1"],
                                                  [UIImage imageNamed:@"im-recv-audio-2"],
                                                  [UIImage imageNamed:@"im-recv-audio-3"], nil]];
                         ...
                         model:(id<IMessageModel>)model
{
    ...
    [_statusButton setImage:[UIImage imageNamed:@"im-send-failed"] forState:UIControlStateNormal];
    [_statusButton setImageEdgeInsets:UIEdgeInsetsMake(6, 0, 0, 6)];
    ...
    if ([self respondsToSelector:@selector(isCustomBubbleView:)] && [self isCustomBubbleView:model]) {
        ...
        switch (messageType) {
            case EMMessageBodyTypeText:
            {
                ...
                _bubbleView.textLabel.textColor = isSender ? _sendMessageTextColor : _recvMessageTextColor;
            }
                break;
            ...
            case EMMessageBodyTypeVoice:
            {
                ...
                _bubbleView.voiceDurationLabel.textColor = isSender ? _sendMessageTextColor : _recvMessageTextColor;
...
{
    //bubble view
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.bubbleView attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationEqual toItem:self.contentView attribute:NSLayoutAttributeBottom multiplier:1.0 constant:-5]];
...
//    self.backgroundColor = [UIColor yellowColor];
    ...
    if ([self respondsToSelector:@selector(isCustomBubbleView:)] && [self isCustomBubbleView:model]) {
        ...
        [self setSendBubbleBackgroundImage:_sendBackgroundImage];
        [self setRecvBubbleBackgroundImage:_recvBackgroundImage];
        _bubbleView.textLabel.textColor = model.isSender ? _sendMessageTextColor : _recvMessageTextColor;
        
        self.leftBubbleMargin = UIEdgeInsetsMake(7, 16, 7, 16);
        self.rightBubbleMargin = UIEdgeInsetsMake(7, 16, 7, 16);
        self.bubbleMargin = UIEdgeInsetsMake(7, 0, 7, 0);
        ...
        switch (model.bodyType) {
            ...
            case EMMessageBodyTypeImage:
            {
                [self setSendBubbleBackgroundImage:_recvBackgroundImage];
                [self setRecvBubbleBackgroundImage:_recvBackgroundImage];
                
                self.leftBubbleMargin = UIEdgeInsetsMake(1.5, 1.5, 1.5, 1.5);
                self.rightBubbleMargin = UIEdgeInsetsMake(1.5, 1.5, 1.5, 1.5);
                self.bubbleMargin = UIEdgeInsetsMake(0, 0, 0, 0);
            ...
            case EMMessageBodyTypeVoice:
            {
                if (_bubbleView.voiceImageView) {
                    _bubbleView.voiceImageView.contentMode = UIViewContentModeScaleAspectFit;
                    if ([self.sendMessageVoiceAnimationImages count] > 0 && [self.recvMessageVoiceAnimationImages count] > 0) {
                        self.bubbleView.voiceImageView.image = self.model.isSender ?[self.sendMessageVoiceAnimationImages objectAtIndex:2] : [self.recvMessageVoiceAnimationImages objectAtIndex:2];
                ...
                _bubbleView.voiceDurationLabel.textColor = self.model.isSender ? _sendMessageTextColor : _recvMessageTextColor;
...
- (void)setSendMessageTextColor:(UIColor *)messageTextColor
{
    _sendMessageTextColor = messageTextColor;
    if (_bubbleView.textLabel) {
        _bubbleView.textLabel.textColor = _sendMessageTextColor;
    }
}

- (void)setRecvMessageTextColor:(UIColor *)messageTextColor
{
    _recvMessageTextColor = messageTextColor;
    if (_bubbleView.textLabel) {
        _bubbleView.textLabel.textColor = _recvMessageTextColor;
    }
}
...
//            height += (retSize.height > 20 ? retSize.height : 20) + 10;
    ...
    height += 5;//EaseMessageCellPadding;
