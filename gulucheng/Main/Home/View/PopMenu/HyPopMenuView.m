...
#define CancelStrImgaeName @"home-closePublish"
...
- (CGRect)getFrameAtIndex:(NSUInteger)index;
{
    ...
    CGFloat buttonViewHeight = (buttonViewWidth - 30);
...
//    
    ...
    CGFloat buttonViewY;
    if (index % 2 == 0) {
        buttonViewX = colnumIndex * buttonViewWidth + (buttonViewWidth - 73 - 84)/2;
    } else {
        buttonViewX = colnumIndex * buttonViewWidth - (buttonViewWidth - 73 - 84)/2;
    }
    
    if (index < 2) {
        buttonViewY = ((rowIndex + 1) * margin + rowIndex * buttonViewHeight) + (kH - toHeight) - 100;
    } else {
        buttonViewY = ((rowIndex + 1) * margin + rowIndex * buttonViewHeight) + (kH - toHeight) - 100;
    }
