...
#define host                @"http://api.91chuanwa.com" //@"http://api.chuanwa.ltd:8080"
...
#define resetPwdverifyCode  @"/feeling/user/resetPwdverifyCode"         // 找回密码获取验证码
...
#define listByImNames       @"/feeling/user/listByImNames"              // 根据环信用户名获得用户列表
...
/*! 钱包相关接口 */
#define userWallet          @"/feeling/user/wallet"                     // 根据当前用户获得钱包信息

#define rewardList          @"/feeling/reward/list"                     // 用户卡片奖金历史记录
#define rewardRule          @"/feeling/reward/rule"                     // 获取获得卡片奖励的规则信息

#define tradeUserWithdraw   @"/feeling/trade/userWithdraw"              // 用户提现
#define tradeLogs           @"/feeling/trade/logs"                      // 用户交易日志查询
